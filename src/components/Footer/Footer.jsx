    ...
    <div className="footer-top py-4">
        <div className="row align-items-center">
            ...
            <div className="ft-right">
               <Button variant='contained' className='btn-main rounded-5 p-3 float-md-end'>Try It For Free</Button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div className="row mt-4">
        <div className="col-12 col-sm-12 col-md-6 col-lg-3">
            <div className="mt-3">
                ...
                <p className="fs-6 mt-3 text-light">© 2023 Sandbox. <br />All rights reserved.</p>
        ...
        <div className="col-12 col-sm-12 col-md-6 col-lg-3">
            <div className="mt-3">
                ...
                <p className="fs-6 mt-3 text-light">Moonshine St. 14/05 Light City, London, United Kingdom</p>
        ...
        <div className="col-12 col-sm-12 col-md-6 col-lg-3">
            <div className="mt-3">
                ...
                <ul className="fs-6 mt-3 text-light">
                    <li>About us</li>
                    <li>Contact us</li>
                    <li>Services</li>
                    <li>terms of Use</li>
        ...
        <div className="col-12 col-sm-12 col-md-6 col-lg-3">
            <div className="mt-3">
                ...
                <p className="fs-6 mt-3 text-light">Subscribe to our newsletter to get our news & deals delivered to you.</p>
